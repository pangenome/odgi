...
int main_sort(int argc, char** argv) {
    ...
    args::ValueFlag<double> p_sgd_eta_max(parser, "N", "first and maximum learning rate for path guided linear 1D SGD model (default: squared longest path measured in steps in the graph)", {'v', "path-sgd-eta-max"});
