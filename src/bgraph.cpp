...
namespace betagraph{
    ...
    handle_t BGraph::get_handle(const handlegraph::id_t& node_id, bool is_reverse) const{
        return hhelper.pack(node_id, is_reverse);
    }
    

    handlegraph::id_t BGraph::get_id(const handle_t& handle) const{
    ...
    handlegraph::id_t BGraph::min_node_id(void) const{
        return graph.min_node_id;
    }

    handlegraph::id_t BGraph::max_node_id(void) const{
