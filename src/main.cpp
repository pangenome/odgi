...
void dg_help(char** argv) {
    cerr << "dg: dynamic succinct variation graph tool" << endl
         << endl
         << "usage: " << argv[0] << " <command> [options]" << endl
         << endl
         << dg::subcommand::PIPELINE << ":" << endl;
         
    dg::subcommand::Subcommand::for_each(dg::subcommand::PIPELINE, [](const dg::subcommand::Subcommand& command) {
...
int main(int argc, char *argv[]) {
    ...
    auto* subcommand = dg::subcommand::Subcommand::get(argc, argv);
